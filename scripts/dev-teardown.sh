...
if command_exists podman; then
    ...
    # Stop containers
    podman stop crm-dev-db crm-dev-backend crm-dev-frontend redis-dev pgadmin-dev 2>/dev/null || true
    
    # Remove containers
    podman rm crm-dev-db crm-dev-backend crm-dev-frontend redis-dev pgadmin-dev 2>/dev/null || true
    ...
    # Remove the network
    podman network rm crm-dev-network 2>/dev/null || true
...
if command_exists docker; then
    ...
    # Stop containers
    docker stop crm-dev-db crm-dev-backend crm-dev-frontend redis-dev pgadmin-dev 2>/dev/null || true
    
    # Remove containers
    docker rm crm-dev-db crm-dev-backend crm-dev-frontend redis-dev pgadmin-dev 2>/dev/null || true
